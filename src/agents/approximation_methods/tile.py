...
class TileCodingFeatureExtractor:
    def __init__(self, num_tilings=16, bins=10, low=None, high=None, iht_size=2048):
    ...
    def __call__(self, state):
        ...
        return feature_vector / (np.linalg.norm(feature_vector) + 1e-8)  # Normalización directa
